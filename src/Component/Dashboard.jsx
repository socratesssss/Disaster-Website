...
function Dashboard() {
  ...
  return (
    <section className='relative'>
      ...
      { isOpen ? <button onClick={toggler} className='fixed bottom-10 z-50 right-10 bg-white sm:w-16 w-10 h-10 sm:h-16 p-2 sm:p-3 rounded-full flex items-center justify-center shadow-2xl hover:bg-gray-400'>
        <CloseIcon className=''/>
      </button>
      :
  ...
  {
    isOpen &&     <div className='w-[331px] h-[475px] bg-[#F4F4F5] absolute bottom-10 sm:bottom-20 rounded-[12px] overflow-hidden right-8  sm:right-14'>
